    ...
    <div class="row">
        <article class="col-lg-6">
            <figure class="tm-person">
                ...
                <figcaption class="tm-person-description">
                    ...
                    <p class="tm-person-about">Pemilik Dari Restoran terbaru yang tinggal di daerah soekarno hatta.</p>
                    <div>
        ...
        <article class="col-lg-6">
            <figure class="tm-person">
                ...
                <figcaption class="tm-person-description">
                    <h4 class="tm-person-name">Chef Renata</h4>
                    <p class="tm-person-title">Chef Handal (lulusan Master Cheff)</p>
                    <p class="tm-person-about">Chef yang berasal dari kalimantan ini adalah chef yang sangat handal dalam memasak
                    dan hasil masakan nya di sukai para pelanggan.</p>
                    <div>
                        <a href="https://fb.com" class="tm-social-link"><i class="fab fa-facebook tm-social-icon"></i></a>
                        <a href="https://twitter.com" class="tm-social-link"><i class="fab fa-twitter tm-social-icon"></i></a>
                    </div>
        ...
        <article class="col-lg-6">
            <figure class="tm-person">
                ...
                <figcaption class="tm-person-description">
                    ...
                    <p class="tm-person-title">Manager Dapur</p>
                    <p class="tm-person-about">Seorang Manager di bagian dapur yang mengatur stok bahan masakan 
                    dan sangat di kagumi banyak karyawan.</p>
                    <div>
                        <a href="https://fb.com" class="tm-social-link"><i class="fab fa-facebook tm-social-icon"></i></a>
                        <a href="https://instagram.com" class="tm-social-link"><i class="fab fa-instagram tm-social-icon"></i></a>
                    </div>
        ...
        <article class="col-lg-6">
            <figure class="tm-person">
                ...
                <figcaption class="tm-person-description">
                    ...
                    <p class="tm-person-title">Direktur Kuliner</p>
                    <p class="tm-person-about">Seorang Direktur kuliner yang hobi keliling mencari kuliner tiap negara 
                    dan sangat di kagumi banyak karyawan.</p>
                    <div>
                        <a href="https://fb.com" class="tm-social-link"><i class="fab fa-facebook tm-social-icon"></i></a>
                        <a href="https://twitter.com" class="tm-social-link"><i class="fab fa-twitter tm-social-icon"></i></a>
